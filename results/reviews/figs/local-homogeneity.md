...
$(log(\mu_i), -log(1 - F^{\text{emp}}(\mu_i)))$. For a more elaborate explanation, please refer to the section "A Two Nearest Neighbors estimator for intrinsic dimension" in [1].
